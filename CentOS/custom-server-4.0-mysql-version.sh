...
#cd && curl https://raw.githubusercontent.com/catonrug/zabbix-scripts/master/CentOS/custom-server-4.0-mysql-version.sh > install.sh && chmod +x install.sh && time ./install.sh 4.0.0-1.1rc3.el7   

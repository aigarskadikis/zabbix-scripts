...
# cd && curl https://raw.githubusercontent.com/catonrug/zabbix-scripts/master/CentOS/custom-server-4.0-LTS-mariadb-version.sh > install.sh && chmod +x install.sh && time ./install.sh

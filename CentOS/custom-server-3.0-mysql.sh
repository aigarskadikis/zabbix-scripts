...
#cd && curl https://raw.githubusercontent.com/catonrug/zabbix-scripts/master/CentOS/custom-server-3.0-mysql.sh > install.sh && chmod +x install.sh && time ./install.sh 3.0.17
